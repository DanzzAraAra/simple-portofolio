...
const projects: Project[] = [
  {
    ...
    description: "A robust public API service handling high-concurrency requests with MongoDB as primary database.",
  ...
  },
  {
    ...
    description: "Digital platform for class management and resource sharing with MongoDB database backend.",
    tech: ["TypeScript", "Node.js", "MongoDB", "EJS"],
  },
  {
    title: "Kuroneko Art AI",
    category: "AI Service",
    url: "https://kuronekokyaaa.vercel.app",
    description: "Text-to-Image generation platform powered by generative AI models.",
    tech: ["Html", "Css", "Javascript"],
  },
  {
    title: "Kuroneko Art Gen 2",
    category: "AI Service",
    url: "https://kuronekoart.vercel.app",
    description: "Advanced iteration of the art generation tool with enhanced stability.",
    tech: ["Html", "Css", "Javascript"],
  },
  {
    title: "Kuroneko Image Editor",
    category: "Image Processing",
    url: "https://kuronekoimg.vercel.app",
    description: "Image-to-Image transformation and editing toolset.",
    tech: ["Html", "Css", "Javascript"],
  },
];
...
const CanvasBackground = () => {
  ...
  return (
    <canvas 
      ref={canvasRef} 
      id="canvas"
      className="fixed inset-0 z-0 w-full h-full bg-[#0c0a09]"
      style={{ display: "block" }}
    />
  );
};
...
export default function Portfolio() {
  return (
    <div className="min-h-screen bg-[#0c0a09] text-stone-200 selection:bg-orange-800/40 font-sans overflow-x-hidden">
          ...
          <div className="grid md:grid-cols-5 gap-8 md:gap-10 items-center">
            ...
            >
              <motion.div
                ...
                transition={{ delay: 0.2 }}
              >
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-4 md:mb-6 tracking-tighter text-stone-100 leading-[0.9]">
                  BACKEND <br />
                  <motion.span 
                    className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 via-amber-500 to-yellow-600"
