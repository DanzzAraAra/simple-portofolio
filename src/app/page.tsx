...
const JsonProfile = () => {
  ...
  const stackList = [
    { name: "Go", color: "#00ADD8", opacityCycle: [0.3, 0.9, 0.3] },
    { name: "Next.js", color: "#ffffff", opacityCycle: [0.4, 1, 0.4] },
    { name: "React.js", color: "#61DAFB", opacityCycle: [0.3, 0.8, 0.3] },
    { name: "Express.js", color: "#d1d5db", opacityCycle: [0.4, 0.9, 0.4] },
    { name: "Astro", color: "#FF5D01", opacityCycle: [0.5, 1, 0.5] },
    { name: "TS", color: "#3178C6", opacityCycle: [0.4, 0.9, 0.4] },
    { name: "MongoDB", color: "#47A248", opacityCycle: [0.5, 1, 0.5] }
  ];
